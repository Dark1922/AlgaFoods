...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	//método de mostrar as mensagem de erro das pesquisas por parametro da crateria
	@Override
	...
	/*Corrigindo exception handler de media type não aceita/ pega o status e o header e retorna um responseentity sem precisar do body*/
	//tirar a exception lançado do spring ao dar o 406
	@Override
	...
	/*Tratando erro de usuário negado ou não autenticado*/
