...
public class RestauranteController {
	...
	public RestauranteDTO buscar(@PathVariable Long restauranteId) {
		Restaurante restaurate = cadastroRestauranteService.buscarOuFalhar(restauranteId);
	...
	public Restaurante atualizarParcial( @PathVariable Long restauranteId, @RequestBody @Valid Map<String, Object> campos,
